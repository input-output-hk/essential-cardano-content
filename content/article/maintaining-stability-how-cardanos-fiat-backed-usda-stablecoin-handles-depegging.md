...
## **  
Manteniendo la estabilidad: cómo la establecoin USDA de Cardano, respaldada por Fiat, maneja la desvinculación**

  
![Una imagen sobre la estable coin USDA de Cardano, en espanol](https://ucarecdn.com/16f00159-ef33-425f-9c1e-d3627b3d91ae/)

**Índice**

*   Desvinculación: La criptonita de las stablecoin
    
*   El diseño de la stablecoin USDA minimiza el riesgo
    
*   No existe una talla única. Pero USDA se adapta a la mayoría.
...
Las stablecoins \[o monedas estables en español\] son criptomonedas diseñadas para mantener la estabilidad de precios y están vinculadas a un activo externo. Se considera que estos activos son una de las columnas vertebrales de la criptomoneda y las DeFi, pero pueden enfrentarse al riesgo de desvinculación si no se gestionan adecuadamente.

> Depegging \[“despegarse” o “desvincularse” en español\] se refiere al fenómeno de que una stablecoin se desvíe de su vinculación prevista.

Hemos presenciado un ejemplo emblemático de desvinculación catastrófico con Terra y la UST de su stablecoin algorítmica LUNA. Ello fue consecuencia de una venta concentrada de UST combinada con una falta de reservas y liquidez que impidió al emisor poder mantener su paridad.

USDA, la stablecoin nativa de Cardano, cuenta con un respaldo total 1:1 a USD. A diferencia de la stablecoin UST algorítmica y la USDA respaldada por fiat, una stablecoin respaldada por fiat que pierde su paridad tiene una probabilidad mucho mayor de volver 1:1 a su activo emparejado porque está totalmente respaldada por efectivo o reservas similares al efectivo. Es posible que un diseño algorítmico, que se basa en las matemáticas y el código para equilibrar la emisión de stablecoin frente a la garantía tokenizada, no sea tan fiable como la USDA para recuperar su paridad. Dado que la USDA está totalmente respaldada 1:1 por los depósitos, la stablecoin USDA ha sido diseñada para mantener la estabilidad, incluso frente a las fluctuaciones del mercado. Ese diseño es a propósito y es la clave de la estabilidad de la stablecoin - el antídoto contra la criptonita en esta analogía.

## **El diseño de la stablecoin USDA minimiza el riesgo**

Podría producirse un acontecimiento de desvinculación \[perder la paridad\] importante como consecuencia de una retirada de efectivo a gran escala en la que una pluralidad de titulares de USDA se “apresurara” a cambiar sus activos a una divisa diferente (fiat u otro activo). La dinámica de la oferta y la demanda es la misma que la de cualquier otra criptomoneda, creando así precios superiores o inferiores a 1 $ en un momento dado. **Pero cualquier desvinculación de la USDA debería ser temporal, en el caso de que se produzca.** USDA está diseñada para funcionar acuñando o quemando monedas USDA a un tipo de cambio fijo de 1 USDA por 1 USD en función de la demanda de los usuarios, garantizando que cada moneda USDA esté respaldada por un dólar estadounidense correspondiente en poder de nuestro socio bancario estadounidense regulado.

En esencia, toda técnica de estabilización se basa en el modelo económico elemental de la oferta y la demanda. La clave para evitar la depreciación es comprender cómo se gestionan las reservas para garantizar un respaldo 1:1. La liquidez de los activos se convierte aquí en la clave. El dólar vinculado está custodiado por un socio bancario estadounidense regulado que lleva una contabilidad adecuada de las reservas en efectivo, lo que permite disponer de los fondos en cualquier momento. En caso de que la volatilidad del mercado hiciera que nuestra stablecoin descendiera por debajo de un dólar, EMURGO o cualquier otra parte estaría en posición de comprar USDA en el mercado y venderla en Anzens, presentando una oportunidad de arbitraje de bajo riesgo. En los próximos meses ofreceremos más información sobre nuestras reservas, incluidos los informes mensuales de atestación - que son informes que se utilizan para ofrecer una instantánea de las reservas y los activos que respaldan al USDA - y un informe técnico.

Atenuar el riesgo en lo que respecta a la USDA es fundamental no solo para la salud del ecosistema Cardano, sino también para su utilidad en la consecución de la visión de la plataforma Anzens de EMURGO Fintech, que incluye un conjunto de aplicaciones Web3 empresariales y de servicios financieros individuales.

Si desea consultar más información, considere la lectura del siguiente artículo:

> ![:es:](https://emoji.discourse-cdn.com/apple/es.png?v=12 ":es:") [Qué ventajas aportan a Cardano las stablecoins algorítmicas y respaldadas por fiat como USDA y DJED](https://forum.cardano.org/t/que-ventajas-aportan-a-cardano-las-stablecoins-algoritmicas-y-respaldadas-por-fiat-como-usda-y-djed/114778) .

## **No existe una talla única. Pero USDA se adapta a la mayoría.**

Resulta improbable que un único diseño sea óptimo para todos los casos de uso. Qué stablecoin es _mejor_ depende de una amplia variedad de factores que compiten entre sí, como el uso previsto, el grado de minimización de la confianza y descentralización deseado, el cumplimiento de las jurisdicciones reguladoras y la escalabilidad. El ecosistema Cardano [admite varios diseños de stablecoin](https://emurgo.io/how-fiat-backed-and-algorithmic-stablecoins-like-usda-and-djed-benefit-cardano/) por esta misma razón.

La establecoin USDA de EMURGO Fintech ofrece a las organizaciones Web3 y a los particulares una opción viable para refugiarse de la volatilidad del mercado y dará paso a más oportunidades para casos de uso en el mundo real. Y con la plataforma y el conjunto de productos de Anzens, la USDA será el activo estable que ofrezca interoperabilidad entre las finanzas tradicionales y las descentralizadas.

## Sobre USDA, la stablecoin nativa de Cardano respaldada por Fiat

[![$USDA-Cardano-Blockchain-Stablecoin](https://global.discourse-cdn.com/business4/uploads/cardano/optimized/3X/9/e/9ec17c094426d5e89fedc99dc84313867c603ea2_2_512x109.png "Maintaining Stability: How Cardano's Fiat-Backed USDA Stablecoin Handles Depegging 1")](https://global.discourse-cdn.com/business4/uploads/cardano/original/3X/9/e/9ec17c094426d5e89fedc99dc84313867c603ea2.png)

USDA -stablecoin de Cardano respaldada por USD que cumple con la normativa para el ecosistema- se lanzará a principios de 2023 y aportará valor al ecosistema Web3 de Cardano de aplicaciones descentralizadas. USDA será un tokens nativo de la blockchain de Cardano que estará respaldado 1:1 por reservas del mundo real. Se pretende que sea un activo estable que pueda desbloquear transacciones globales rápidas sin los retrasos de las infraestructuras bancarias y de pago tradicionales. La USDA es la llave que desbloqueará todos los futuros casos de uso y aplicaciones que estarán disponibles en Anzens.

Únase desde ahora a la lista de espera en [https://www.anzens.com](https://www.anzens.com) [2](https://www.anzens.com/) para estar preparado para la USDA.

**Sobre USDA**

*   Sitio Web Oficial: [anzens.com](//anzens.com) [2](https://www.anzens.com/)
...
*   Sitio Web Oficial: [EMURGO.io](//EMURGO.io)
...
Traducción al español de [“Maintaining Stability: How Cardano’s Fiat-Backed USDA Stablecoin Handles Depegging” 1](https://emurgo.io/how-cardano-usda-stablecoin-handles-depegging/), escrito por [@EMURGO\_io](https://forum.cardano.org/u/emurgo_io), en marzo 6 de 2023.
