...
3月上旬にコロラド州で開催された[Cardanoガバナンスワークショップ](https://www.essentialcardano.io/video/cip-1694-community-workshop)や、3月30日にオンラインで開催されたこのイベントのまとめは、こうしたコラボレーションの好例です。コミュニティの主要な貢献者と思想的リーダーが主導した両ワークショップは、コミュニティの幅広い関心と経験からインプットを取り込むことで、エンゲージメントの深化と洞察の収集に役立ちました。参加者は、[CIP-1694](https://github.com/JaredCorduan/CIPs/blob/voltaire-v1/CIP-1694/README.md)で提案されたオンチェーンガバナンスシステムを洗練し、検討するために、さまざまな共同活動や議論に参加しました。ワークショップは生産的であり、将来のコミュニティイベントのモデルを確立し、ガバナンスフレームワークにおけるコラボレーションと包摂性の重要性を浮き彫りにしました。 

これまでのCIP-1694に関する議論は、ほんの始まりにすぎません。本日、2023年5月、6月、7月に開催されるコミュニティワークショップを支援するための助成プログラムが開始されました。このグローバルなコミュニティイベントを締めくくるのは、6月と7月にEMURGOとIOGの共催で東京とスコットランドのエディンバラで開催される2つのワークショップです。エディンバラで7月に行われるのが今年最後のワークショップとなり、CIP-1694の設計のフィードバックループも終了します。各共催イベントの日程は5月上旬に発表されます。

**参加方法**

グローバルコミュニティのリーダーやグループには、独自のワークショップを開催することが奨励されており、金銭的な支援も提供されています。これは、各自がCardanoとガバナンスに関する議論を地域社会にもたらすチャンスです。コミュニティ主導のイベントは、Cardanoのガバナンスへの参加、貢献を望むすべての人を歓迎する必要があります。CIP-1694ワークショップの実施に関心がある場合は、次の一部またはすべてをカバーするイベントを企画して申請してください。
...
各ワークショップでは、合意された形式で成果の概要を作成します。これは、より大きなテーマやトピックにまとめられ、さらなる議論や検討が促されます。各主催者は、ワークショップ後にアンケートを実施することが期待されます。

さらに、各主催者は、エディンバラの最終イベントでワークショップの成果を発表する代表者を指名する機会があります（旅費はカバーされます）。
...
コミュニティ主導のイベントを開催したい方は、[こちら](https://forms.gle/ZtGZW9aVHrHvHCRx6)からお申し込みください。応募受付は4月18から開始され、日本時間2023年5月2日(火)午前8:00に締め切られます。 

**よくある質問**

**複数のイベントを実行できますか。**

はい、可能です。申請書で計画を示すことができます。ただし、広範なコミュニティグループを代表させるために、または重複がある場合（たとえば、同じ場所で複数のイベントを開催するなど）、申請内容の見直しが要求される場合があります。野心的な応募や、より幅広い参加者を募りたいという応募を拒否することはありませんが、同じ場所などで複数の応募がある場合は、プランの一部を見直していただくことがありますのでご了承ください。

**イベントの期間はどのくらいですか。**

対面式ワークショップの場合は、1日全日が期待されます。仮想の場合は2～3時間が推奨されますが、絶対ではありません。重要なのは、コミュニティからの貴重なインプットを可能な限り効果的に（そして楽しく）得ることです。

**金銭的サポートはどのように提供されますか。**

金銭的サポートは、仮想ワークショップと対面式ワークショップの両方で利用可能です。申請が通ったすべての仮想ワークショップに対して、500米ドルが支払われます。対面式ワークショップの場合、最大5,000米ドルまで増額されますが、会場のレンタルやその他の関連コストの証明が必要になります。5,000米ドルは目標額ではなく上限であり、申請にはコストの内訳が必要になります。 

支払いはイベント後（仮想と対面式共に）に行われますが、状況によっては、より早い段階でサポートが提供される場合もあります（会場の確保など）。ワークショップの成果報告は、助成金の基準の一部として必要となります。

**IOG、Cardano財団、EMURGOの代表者はワークショップに参加しますか。**

はい。しかし、予想されるイベントの幅を考えると、場所、日付、時間次第となります。したがって、IOG、Cardano財団、EMURGOの出席は保証されません。申請が通り、代表者が参加する機会があれば、主催者に直接確認します。

**最後に開催されるイベントはいつですか。**

総括イベントは7月中旬にエディンバラで開催予定です。すべてのコミュニティワークショップは、少なくともこの5日前までに完了して成果を共有している必要があります。
