...
\- **Chang upgrade**: initiated Conway era and introduced first set of on-chain governance capabilities  
\- **Plomin upgrade**: extended Conway with full governance actions and decentralized representatives (DReps) on mainnet (epoch 537, protocol version 10.0) | Chang and Plomin upgrades |
